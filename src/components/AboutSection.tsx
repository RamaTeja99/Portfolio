        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="w-full h-[350px] bg-gray-900 rounded-2xl overflow-hidden">
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-tech-purple rounded-2xl -z-10 opacity-70"></div>
              <div className="absolute -top-6 -left-6 w-32 h-32 border-2 border-tech-blue rounded-2xl -z-10 opacity-70"></div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <h4 className="font-bold text-white mb-3">Email</h4>
                <p className="text-gray-400">2200032668cseh@gmail.com</p>
              </div>
              
              <div>
                <h4 className="font-bold text-white mb-3">Phone</h4>
                <p className="text-gray-400">+91 9963400955</p>
              </div>
              
              <div>
                <h4 className="font-bold text-white mb-3">Degree</h4>
