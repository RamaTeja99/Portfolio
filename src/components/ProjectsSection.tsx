  ...
  const projects = [
    {
      ...
      description:
        "Designed to leverage advanced management tools for tracking and maintaining student extracurricular achievements. It enables institutions to add, update, and modify student records seamlessly.",
    ...
    },
    {
      title: "CloudBasedVPN",
      description:
        "A cloud-based VPN platform using WireGuard, with dynamic config and QR code generation, built on a modern fullstack setup.",
      tech: ["Spring Boot", "Java", "MySQL"],
    ...
    },
    {
      ...
      description:
        "Smart Mobile Vijayawada is a full-stack mobile store platform with a Vite + React + TypeScript frontend and a RESTful backend for secure data management. Enables seamless CRUD operations and integration, supporting efficient end-to-end mobile retail experiences.",
      tech: ["MongoDB", "Express", "React", "Node.js"],
      link: "https://github.com/RamaTeja99/smart-mobile-vijayawada.git",
